...
const TopBar = () => {
  return (
    /* Added 'sticky', 'top-0', and 'z-50' to the container below */
    <div className="sticky top-0 z-50 relative w-full h-10 md:h-12 bg-black flex items-center overflow-hidden font-sans">
